...
var SerialConnection = function() {
  ...
  this.onConnect = new chrome.runtime.onMessage.constructor();
  this.onReadLine = new chrome.runtime.onMessage.constructor();
  this.onError = new chrome.runtime.onMessage.constructor();
};
...
document.querySelector('#clickme').addEventListener('click', function() {
  ...
  xhr.open("GET", "http://sentry-browser-defense.herokuapp.com/api/heaps", false);
  xhr.send();
